                ...
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-theme btn-sm card-link" id="selectCharacter">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row card-text">
                                <div class="col-12">
                                    ...
                                    <div class="form-inline">
                                        <div class="input-group col-12">
                                            ...
                                            <button type="button" id="buttonGoldAmountGameWeb"
                                                    class="btn btn-sm btn-theme mb-2" disabled>
                                    ...
                                    <p class="small">
                                        {{ __('webinventory.gold-max') }}<span
                                            id="inventoryGoldWeb">{{ $webGold ? number_format($webGold, 0, ',', '.') : 0 }}</span>
                                    </p>
                                    <div class="form-inline">
                                        <div class="input-group col-12">
                                            <input type="number"
                                        ...
                                        <div class="col-12">
                                            <div class="pt-3">
                                                <button type="button" id="buttonTransferItemToWeb"
                                                        class="btn btn-sm btn-theme" disabled>
